class Button {
  constructor(x, y, label, col, onClick, shapes = null, type = "continent") {
    this.x = x;
    this.y = y;
    this.label = label;
    this.col = col;
...
function makeContinentButton(x, y, label, col, shapes) {
  return new Button(
    x, y, label, col,
    (btn) => {
...
function setupButtons() {
  ...
  buttons.push(
  makeContinentButton(0, 0, "North America", color(178,0,55), [
   [ [0,0],[135,0],[135,49],[112,49],[112,73],[88,73],[88,90],[40,90],[40,73],[26,73],[26,49],[0,49]]
  ])
);  

buttons.push(
  makeContinentButton(0, 0, "Central America", color(216,14,67), [
   [ [26,73],[40,73],[40,90],[63,90],[63,110],[75,110],[75,121],[26,121]]
  ])
);  
  
    buttons.push(
  makeContinentButton(0, 0, "Caribbean", color(249,143,186), [
   [ [80,96],[116,96],[116,106],[80,106]]
  ])
);   

      buttons.push(
  makeContinentButton(0, 0, "South America", color(247,70,129), [
   [ [75,121],[120,121],[120,136],[147,136],[147,170],[136,170],[136,195],[112,195],[112,218],[95,218],[95,170],[75,170],[75,121]]
  ])
); 

buttons.push(
  makeContinentButton(0, 0, "Nothern Europe", color("#1289b2"), [
 [[208,19],[244,19],[244,45],[208,45]],
  [[185,24],[197,24],[197,36],[185,36]]
    ...
    buttons.push(
  makeContinentButton(0, 0, "Western Europe", color("#32dce0"), [
   [ [198,45],[221,45],[221,57],[213,57],[213,64],[198,64]]
  ])
); 
  
buttons.push(
  makeContinentButton(0, 0, "Southern Europe", color("#9ff7f0"), [
    ...
    buttons.push(
  makeContinentButton(0, 0, "Eastern Europe", color("#00b6ce"), [
   [ [244,19],[427,19],[427,49],[402,49],[402,61],[382,61],[382,49],[268,49],[268,64],[221,64],[221,45],[244,45]]
  ])
); 

buttons.push(
  makeContinentButton(0, 0, "Eastern Asia", color("#5780f2"), [
  ...
  buttons.push(
  makeContinentButton(0, 0, "Central Asia", color("#77baf7"), [
   [ [282,49],[320,49],[320,73],[282,73]]
  ])
);  

  buttons.push(
  makeContinentButton(0, 0, "Southern Asia", color("#7a9ffc"), [
   [ [282,73],[320,73],[320,85],[341,85],[341,97],[330,97],[330,122],[305,122],[305,92],[282,92]]
  ])
);  
  
  buttons.push(
  makeContinentButton(0, 0, "Western Asia", color("#9fd0fc"), [
   [ [242,64],[268,64],[268,73],[282,73],[282,98],[294,98],[294,110],[268,110],[268,98],[257,98],[257,73],[242,73]]
  ])
);
  
buttons.push(
  makeContinentButton(0, 0, "Southeastern Asia", color("#5d5dd8"), [
  ...
  buttons.push(
  makeContinentButton(0, 0, "Micronesia", color("#b95ff9"), [
   [ [445,115],[457,115],[457,127],[445,127]]
  ])
);   

  buttons.push(
  makeContinentButton(0, 0, "Polynesia", color("#c681f7"), [
   [ [487,145],[500,145],[500,158],[487,158]]
  ])
);   

  buttons.push(
  makeContinentButton(0, 0, "Melanesia",  color("#c338e5"), [
   [ [422,140],[447,140],[447,152],[422,152]]
  ])
);  

buttons.push(
  makeContinentButton(0, 0, "Australia & New Zealand",  color("#b219b2"), [
    // first polygon
  ...
  buttons.push(
  makeContinentButton(0, 0, "Nothern Africa", color("#e6fcac"), [
   [ [175,80],[233,80],[233,87],[257,87],[257,121],[233,121],[233,101],[175,101]]
  ])
);

buttons.push(
  makeContinentButton(0, 0, "Eastern Africa", color("#fffcd0"), [
    // first polygon
  ...
  buttons.push(
  makeContinentButton(0, 0, "Middle Africa", color("#fff974"), [
  ...
  buttons.push(
  makeContinentButton(0, 0, "Western Africa", color("#d7f763"), [
    [[175,101],[217,101],[217,134],[175,134]]
  ])
);
  
  buttons.push(
  makeContinentButton(0, 0, "Southern Africa", color("#fff319"), [
